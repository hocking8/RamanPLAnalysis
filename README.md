...
When inputting guesses (list) into the fit_peaks function, you should include integer multiples of 3 or 7 depending
on whether you're doing a Lorentzian/Gaussian or a Voigt. It can fit any number of peaks, but the fitting
depends more strongly on your initial guesses as you increase the number of peaks. You can also input multiple 
sets of guesses by sending in a nested list, and the script will select the fit that results in the lowest RSS. 
This is helpful in cases where you fitting an entire map and there are multiple potential peak shapes. 
